...
public class TestSimpleFacetsExample extends LuceneTestCase {
  ...
  public void testFacetOnly() throws Exception {
    var results = new SimpleFacetsExample().runFacetOnly();
  ...
  public void testSimple() throws Exception {
    var results = new SimpleFacetsExample().runSearch();
    assertEquals(2, results.size());
    assertEquals(
        "dim=Author path=[] value=5 childCount=4\n  Lisa (2)\n  Bob (1)\n  Susan (1)\n  Frank (1)\n",
        results.get(0).toString());
  ...
  public void testDrillDown() throws Exception {
    var result = new SimpleFacetsExample().runDrillDown();
    assertEquals(
  ...
  public void testDrillSideways() throws Exception {
    var result = new SimpleFacetsExample().runDrillSideways();
    assertEquals(
        "dim=Publish Date path=[] value=5 childCount=3\n  2010 (2)\n  2012 (2)\n  1999 (1)\n",
